...
研究方向聚焦于 **多模态表征学习（Multimodal Representation Learning）** 与 **对比学习（Contrastive Learning）**，主要应用于 **文本-视频检索（Text–Video Retrieval）** 和 **推荐系统（Recommendation Systems）** 领域。
